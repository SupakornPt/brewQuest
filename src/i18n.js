...
const resources = {
    en: {
        translation: {
            ...
            "answer21": "Study the map carefully and plan before setting out.",
            "answer22": "Invite friends to join the adventure right away!",
            ...
            "suggest": "are best matched with a"
    ...
    th: {
        translation: {
            ...
            "question2": "ขณะเดินทาง คุณเจอทางแยกสองทาง ทางหนึ่งมีป้ายเตือนอันตราย อีกทางปลอดภัยแต่ไกลกว่า คุณเลือกเส้นทางไหน",
            "answer21": "ศึกษาแผนที่อย่างละเอียด วางแผนก่อนออกเดินทาง",
            "answer22": "ชวนเพื่อนๆมาผจญภัยด้วยกันทันที",
